package com.convertion2.Config;
...
public class UserExcelExporter {
	...
	private void writeDataLines() {
		...
		for(Student stu:listStudent) {
			...
			createCell(row, columnCount++, stu.getAge(), style);
			createCell(row, columnCount++, stu.getCity(), style);
			createCell(row, columnCount++, stu.getGender(), style);
		}
	}
